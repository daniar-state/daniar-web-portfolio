			...
			<div className='flex gap-4 flex-col md:flex-row items-center'>
				...
				<div className='text-zinc-400'>
					<p className='text-zinc-200 text-xl'>
						Привет, меня зовут Данияр Жабагин
					</p>
					<p className='text-zinc-400'>
						Я занимаюсь разработкой веб-сайтов и программного обеспечения на
						базе Javascript (NodeJS, React), Python (Django, Flask, FastAPI). Я
						могу помочь, если вам нужен надежный разработчик и технический
						партнер для решения ваших бизнес-задач или вопросов. <br />
						<br />
						В течение последних 6 лет я предоставляю следующие услуги:
						<br />
